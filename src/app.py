...
activities = {
    ...
    "Soccer Team": {
        "description": "Teamwork, fitness, and competitive soccer matches",
    ...
    "Art Workshop": {
        ...
        "max_participants": 15,
        "participants": ["julia@mergington.edu", "henry@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, stage production, and performance rehearsals",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 14,
        "participants": ["lily@mergington.edu", "jason@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop public speaking and critical thinking in debate",
